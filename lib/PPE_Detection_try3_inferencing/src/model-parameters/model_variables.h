...
const char* ei_classifier_inferencing_categories[] = { "Helmet", "Person", "Safety_shoes", "Vest" };
...
const ei_config_tflite_eon_graph_t ei_config_graph_13 = {
...
ei_learning_block_config_tflite_graph_t ei_learning_block_config_13 = {
    ...
    .quantized = 1,
    .compiled = 1,
    .graph_config = (void*)&ei_config_graph_13
};
...
const ei_fill_result_fomo_i8_config_t ei_fill_result_fomo_i8_config_13 = {
    .threshold = 0.5,
    .out_width = 12,
    .out_height = 12,
...
const ei_postprocessing_block_t ei_postprocessing_blocks[ei_postprocessing_blocks_size] = {
    {
        ...
        .display_fn = NULL,
        .config = (void*)&ei_fill_result_fomo_i8_config_13,
        .input_block_id = 13
    },
};

const ei_impulse_t impulse_726776_0 = {
    .project_id = 726776,
    .project_owner = "lmansain",
    .project_name = "PPE_Detection_try3",
    .impulse_id = 3,
...
ei_impulse_handle_t impulse_handle_726776_0 = ei_impulse_handle_t( &impulse_726776_0 );
ei_impulse_handle_t& ei_default_impulse = impulse_handle_726776_0;
